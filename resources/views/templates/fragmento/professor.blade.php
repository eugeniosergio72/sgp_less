...
<html lang="pt-PT" xmlns:th="http://www.thymeleaf.org">
    ...
    <body>
        ...
        <nav class="container mt-3 bg-dark p-4 mb-5" id="professorNav">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 assunto text-left">
                    <button type="button" data-toggle="modal" data-target="#cadastrarDisciplina" class="btn btn-outline-light">
                        Nova Disciplina
                    </button>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 disciplina text-center">
                    <button type="button" data-toggle="modal" data-target="#cadastrarAssunto" class="btn btn-outline-light">
                        Novo Assunto
                    </button>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 registarProva text-right">
                    <a href="/cadastrarProva" class="btn btn-outline-light">
                        Nova Prova
                    </a>
                </div>
            </div>
